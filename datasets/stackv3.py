...
if __name__ == "__main__":
    ...
    # We create our most powerful, diverse set of base learners
    estimators = [
        ('rf', RandomForestClassifier(n_estimators=100, random_state=42, n_jobs=-1)),
        ('logreg', LogisticRegression(multi_class='ovr', solver='liblinear', random_state=42)),
        ('xgb_base', XGBClassifier( # Add XGBoost as a base learner
            n_estimators=100, 
            n_jobs=-1,
            random_state=42, 
            objective='multi:softmax', 
    ...
    print(f"\n Stacking Ensemble (RF+LogReg+XGB -> XGB, on PCA data):")
